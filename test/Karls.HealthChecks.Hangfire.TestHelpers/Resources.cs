...
namespace Karls.HealthChecks.Hangfire.TestHelpers;
...
public static class Resources {
    ...
    internal static Assembly GetTestAssembly() {
        ...
        var assembly = assemblies.FirstOrDefault(assembly => {
            ...
            if(!assemblyName.StartsWith("Karls.HealthChecks.Hangfire.", StringComparison.Ordinal))
                return false;

            if(assemblyName == "Karls.HealthChecks.Hangfire.TestHelpers")
                return false;
